 ...
 *    - The icon is invisible at first, but shows up when the mouse hovers over the header
 *
...
(function () {
    ...
    function addCopyIcons() {
        ...
        headers.forEach(header => {
            ...
            header.addEventListener('mouseenter', () => copyIcon.style.display = 'inline-block');
            header.addEventListener('mouseleave', () => copyIcon.style.display = 'none');
